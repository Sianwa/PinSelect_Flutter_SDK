...
class _MyHomePageState extends State<MyHomePage> {
  ...
  final String serialNumber = "507922062";
  ...
  Future<void> initialize() async {
    ...
    var resp = await pinSelect.initialize(
        accountModel: accModel, institutionModel: instModel);

    //call function to change pin
    if (resp != null) {
      await changePin(resp.callbackUrl, resp.uuid);
    }
  }
